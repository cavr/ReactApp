...
import { addNumber, addParameter, addOperator, addFunction, deleteOperation, openBracket, closeBracket } from 'actions/mis/admin/metricManager';
...
export class FormulaInput extends PureComponent {
  ...
  render() {
    const { parameters, addNumber, addOperator, addParameter, addFunction, deleteOperation, openBracket, closeBracket } = this.props;
