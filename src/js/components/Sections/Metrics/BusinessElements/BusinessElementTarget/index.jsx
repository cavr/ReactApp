      ...
      <li className='business-element-metric'>
        ...
        <Collapse isOpened={ showingEvolution }>
          <div className='main-graph__details-wrapper'>
            {
              loading === false ? <Evolution label={ evolutionData.label } variation={ evolutionData.variation } points={ evolutionData.points } target={ evolutionData.target } maxValue={ evolutionData.maxValue } minValue={ evolutionData.minValue } /> :
              <Loading small={ true } />
            }
          </div>
        </Collapse>
